...
export default function ImageTrail({ items = [], variant = 1 }: ImageTrailProps): JSX.Element {
  ...
  return (
    <div className="w-full h-full relative z-20 rounded-lg bg-transparent overflow-visible" ref={containerRef}>
      {items.map((url, i) => (
        <div
        ...
        >
          <div
            className="content__img-inner bg-center bg-contain bg-no-repeat w-[calc(100%+30px)] h-[calc(100%+10px)] absolute top-[-10px] left-[-10px] p-3"
